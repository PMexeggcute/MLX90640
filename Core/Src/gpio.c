...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LCD_SDA_Pin|LCD_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LCD_SDA_Pin LCD_SCL_Pin LCD_CS_Pin */
  GPIO_InitStruct.Pin = LCD_SDA_Pin|LCD_SCL_Pin|LCD_CS_Pin;
